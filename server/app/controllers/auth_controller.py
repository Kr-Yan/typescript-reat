...
class AuthController:
        ...
        return User(id=user_with_password.id,
                   email= user_with_password.email,
                    name=user_with_password.name,
                     wallets= user_with_password.wallets,
    ...
    def register(user_data: UserRegister) -> User:
        ...
        invalid_invite_code= next((u for u in mock_users_with_passwords if u.invite_code==user_data.invite_code),None)
        ...
        mock_users_with_passwords.append(new_user_with_password)
        data_service.save_users(new_user_with_password)
